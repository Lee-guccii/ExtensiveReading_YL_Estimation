...
while text_suu < 65:
    ...
    #因果関係のある動詞
    inga_setuzokusi=["come", "comes", "came","coming", "result", "results", "resulted","resulting","lead","leads","leading","led","contribute","contributes","contributed","contributing","cause","causes","causing","caused","impact","impacts","impacting","impacted"]
    inga_setuzokusi=["result","lead","contribute","cause","impact","spread","divide","move","give"]
